---
title: Installation
description: Getting started with irisui
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://iris-ui-three.vercel.app/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://iris-ui-three.vercel.app/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://irisui/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json
```
...
```jsx
import Card05 from "@/components/irisui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://iris-ui-three.vercel.app/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://iris-ui-three.vercel.app/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://iris-ui-three.vercel.app/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/irisui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://iris-ui-three.vercel.app/r/card-05.json -c ./apps/www
```

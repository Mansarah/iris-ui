...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched irisui UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "irisui UI Documentation",
            description: "A comprehensive guide to irisui UI",
